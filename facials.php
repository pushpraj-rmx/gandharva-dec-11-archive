        ...
        <div class="row row-50 align-items-lg-center justify-content-xl-between">
          <div class="col-lg-6">
            <div class="block-xs">
              ...
              <p class="big text-gray-800">The best Gandharva Wellness Studio in Preet Vihar, Delhi can enhance your
                look. We are not only a salon-shop, but also transform the appearance of a person. Our diverse looks can
                fill you with confidence.

              </p>
              <p>At Gandharva, the salon means a complete body makeover, including a pedicure and manicure using the
                latest technology. Our aesthetic studio will also let you feel complete relaxation from the soul to the
                spirit.
        ...
        <div class="row justify-content-center">
          <div class="col-md-10 col-lg-9">
            <p>For a complete identity change with the feel of nature,
              ...
              <br class="d-none d-sm-inline">you should visit the best salon service provider in Preet Vihar, Delhi.
            </p>
          </div>
        </div>
        <div class="row icon-modern-list no-gutters">
          <div class="col-sm-6 col-lg-4">
            <article class="box-icon-modern modern-variant-2">
              ...
              <p>Smooth decorating nails and effective pedicure with professional and painless methods can sweep your
                glamor party.
          ...
          <div class="col-sm-6 col-lg-4">
            <article class="box-icon-modern modern-variant-2">
              ...
              <div class="divider"></div>
              <p>A soft hand with attractive nails can increase a person's courage in society and having the best salon
                service in your shopping cart can increase it.
          ...
          <div class="col-sm-6 col-lg-4">
            <article class="box-icon-modern modern-variant-2">
              ...
              <div class="divider"></div>
              <p>Organic beauty products without any irritation and 100% follicles from the face can brighten you up for
          ...
          <div class="col-sm-6 col-lg-4">
            <article class="box-icon-modern modern-variant-2">
              ...
              <div class="divider"></div>
              <p>Transforming your beard with an appropriate facial belief at an ordinary price will surely make you an
                attractive guy with a professional approach.
          ...
          <div class="col-sm-6 col-lg-4">
            <article class="box-icon-modern modern-variant-2">
              ...
              <div class="divider"></div>
              <p>Shampoo & Conditioning from the expert cosmetologist not only gives you a scalp massage, but also
                shapes and beautifies your hair.
          ...
          <div class="col-sm-6 col-lg-4">
            <article class="box-icon-modern modern-variant-2">
              ...
              <div class="divider"></div>
              <p>Remove the shackles of a glamorous face obscured by the sun's shadow, just to make it shine in the
                crowd.
