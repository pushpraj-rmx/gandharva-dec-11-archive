...
<head>
  ...
  <meta
    ...
    name="description" />
  <meta content="ayurveda therapies, best ayurveda therapies treatment" name="keywords" />
  <link rel="canonical" href="https://gandharvawellness.com/ayurveda-therapies.html" />
...
<body>
  ...
  <div class="page">
      ...
      <div class="container">
        <div class="row row-50 align-items-lg-center justify-content-xl-between">
          <div class="col-lg-6">
            ...
            <div class="block-xs">
              <h2 class="heading-decorate">What is it?</h2>
              <p class="text-gray-800">
                Ayurveda is not only one of the most ancient sciences but,
                it’s relevant even today. Ayurveda, which has nature at its
                core, helps us comprehend that nature holds the answers to all
                of our problems with the body and mind. We, the Human species,
                have broken our bond with nature, and as a result, we feel
                physical and mental suffering.
              </p>
              <h4 class="heading-decorate">Pitta Dosha</h4>
              <p class="text-gray-800">All heat, metabolism, and transformation in the body and mind are governed by
                pitta. It regulates how we metabolise our sensory inputs, how we break down food, and how we distinguish
                between right and evil. Pitta is in charge of the body's vital digestive "Agni," or fires. Do you have
                an unbalanced pitta? If so, you might be exhibiting a few of the symptoms or signs listed below:
              </p>
              <li>Acute inflammation in the body or joints, a red, inflamed rash, acne, or cold sores, as well as
                heartburn, acid reflux, gastric or peptic ulcers, nausea, and discomfort after missing meals</li>
              <p>
                <li>Squishy stools</li>
                <li>Excess mucous </li>
                <li>White tongue coat</li>
                <li>Sluggish bowel movements</li>
                <li>Difficulty rising in the morning</li>
                <li>Feeling slow, foggy, dull, lethargic, or heavy</li>
                <li>Easily attached or possessive</li>
                <li>Overly sentimental and stubborn</li>
                <li>A tendency for “emotional overeating”</li>
              </p>
              <!-- <a class="button button-default-outline" href="https://gandharva/contact_us.html">Book Now</a> -->
    <!-- </div>

          </div>
          <div class="col-lg-6">
            <img class="" src="images/ayurveda/img1.jpg" alt="" width="568" height="459" />
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6">
    ...
    <!-- <h4 class="heading-decorate">Vata Dosha</h4>
              <p class="text-gray-800">It regulates respiration, waste removal, blood flow, and the passage of thoughts
                throughout the mind. <br> <br>
                Do you have an unbalanced Vata? If so, you might be exhibiting some of the symptoms listed below :
              </p>
              <p>
                Signs include
                <li>trembling, twitchig, tics, panic, fright, and spasms.
                <li>constipation, gas, bloating, dry, hard faeces, low body weight </li>
                <li> chapped or dry skin</li>
                <br>
    ...
    <!-- </div>
          ...
          <div class="col-lg-6">
            <img src="images/ayurveda/img4.jpg" alt="">
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6">
    ...
    <!-- <h4 class="heading-decorate">Kapha Dosha</h4>
              <p class="text-gray-800">The earth and water components combine with the kapha type. As a result, Kapha
                combines qualities like weighty, steady, and sluggish with others like soft, dense, tough, and chilly.
                Do you have an unbalanced Kapha? If so, you may be exhibiting a few of the symptoms or signs listed
                below : <br> <br>
              </p>
              <p>
                <li> </li>
    ...
    <!-- </div>
          ...
          <div class="col-lg-6">
            <img src="images/ayurveda/img3.jpg" alt="">
          </div>
        </div>
      </div>
        </div> -->
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-10 col-lg-9">
            <h5 class="box-icon-modern-title"> Specialized Treatment Packages</h5>
            <h6 class="box-icon-modern-title">under supervision of Ayurveda Dr.</h6>
        ...
        <div class="row icon-modern-list no-gutters">
          ...
          <div class="col-sm-6 col-lg-6 col-sm-12">
            <article class="box-icon-modern modern-variant-2">
              ...
              <h4 class="box-icon-modern-title">
                <a href="services.html">Vishuddhi : <br> Detoxification Programme <br> 18 Days</a>
              </h4>
          ...
          <div class="col-sm-6 col-lg-6 col-sm-12">
            <article class="box-icon-modern modern-variant-2">
              ...
              <h4 class="box-icon-modern-title">
                <a href="services.html">Nikhar : <br> Beauty-enhanement Programme <br> 30 days
                </a>
              </h4>
              <div class="divider"></div>
              <p>
          ...
          <div class="col-sm-6 col-lg-6 col-sm-12">
            <article class="box-icon-modern modern-variant-2">
              ...
              <h4 class="box-icon-modern-title">
                <a href="services.html">Oorja: <br> Rejuvenation <br> 15 days</a>
              </h4>
              <div class="divider"></div>
              <p>
          ...
          <div class="col-sm-6 col-lg-6 col-sm-12">
            <article class="box-icon-modern modern-variant-2">
              ...
              <h4 class="box-icon-modern-title">
                <a href="services.html">Shoolhari: <br> Pain Management <br> 30 days</a>
              </h4>
              <div class="divider"></div>
              <p>
          ...
          <div class="col-sm-6 col-lg-6 col-sm-12">
            <article class="box-icon-modern modern-variant-2">
              ...
              <h4 class="box-icon-modern-title">
                <a href="services.html">Vish-Haran: <br> Gut Cleansing <br> 14 days</a>
              </h4>
              <div class="divider"></div>
              <p>
                ...
                toxins it’s holding from ages. It helps in weight management, hypertension, PCOS/PCOD and diabetes,
                and helps you in living life to the fullest. </p>
            </article>
          </div>
          <div class="col-sm-6 col-lg-6 col-sm-12">
            <article class="box-icon-modern modern-variant-2">
              ...
              <h4 class="box-icon-modern-title">
                <a href="services.html">Diabetes Management Programme <br> 90 Days </a>
              </h4>
              <div class="divider"></div>
              <p>
          ...
          <div class="col-sm-6 col-lg-6 col-sm-12">
            <article class="box-icon-modern modern-variant-2">
              ...
              <h4 class="box-icon-modern-title">
                <a href="services.html">Ayush : <br> Anti-aging programme <br> 90 days</a>
              </h4>
              <div class="divider"></div>
              <p>
                Making use of the principles of the anti-aging activity described in Ayurveda. Vayasthapana
                (age-defying),
                ...
                (retarding aging). Many rasayana Plants such as Emblica Officinalis (Amla) and Centella Asiatica
                (Gotukola)
          ...
          <article class="box-icon-modern modern-variant-2">
            ...
            <div class="divider"></div>
            <p>
              A practise in Ayurveda that involves delicately applying medicinal oils to the forehead (regarded as the
              third eye). </p>
            <p>
              Enter deeper levels of relaxation as you experience a gentle, steady flow of oils that are tailored to
              your specific needs. It calms down the vata dosh.
            </p>
        ...
        <div class="col-sm-6 col-lg-6 col-sm-12">
          <article class="box-icon-modern modern-variant-2">
            ...
            <div class="divider"></div>
            <p>
              A condition known as <strong> naval displacement </strong>occurs when the stomach and navel muscles are
              out of alignment and
              the navel axis changes. The navel, nerves, stomach muscles, and the movement of Prana are all closely
        ...
        <div class="col-sm-6 col-lg-6 col-sm-12">
          <article class="box-icon-modern modern-variant-2">
            ...
            <p>Other names for it include Shashtika Shali Pinda Sweda (Shashtika means sixty, Shali means rice, Pinda
              means poultice, Sweda means sweat). After being processed with milk and herbal decoctions, a particular
              kind of rice known as Shashtika Shali is harvested after sixty days and utilised only for Ayurvedic
              therapies.</p>
            <h5 class="box-icon-modern-title">RECOMONDED IN</h5>
            <ul>
        ...
        <div class="col-sm-6 col-lg-6 col-sm-12">
          <article class="box-icon-modern modern-variant-2">
            ...
            <div class="divider"></div>
            <p>
              A nutritious head-to-toe massage, frequently using a doshic-specific oil, helps lubricate joints and flow
              lymph fluids throughout our body.
            </p>
            <h5 class="box-icon-modern-title">RECOMONDED IN</h5>
            <ul>
        ...
        <div class="col-sm-6 col-lg-6 col-sm-12">
          ...
          <!-- <img src="images/ayurveda/herbal.png" alt="">
            ...
            <div class="divider"></div>
            <p>
              Since the beginning of time, people have been performing herbal Potli massages. Herbal potlies aid in
              easing pain and encourage improved circulation as well as complete relaxation. It has an impact on our
              spirit, mind, body, and emotions. </p>
            <p>Traditional Ayurvedic Compress Pouch filled with herbs that are selected based on the individual's dosha.
              Various pressures are used to apply the mixture of herbs and oils to the skin after being wrapped into
              muslin bags.</p>
            <h5 class="box-icon-modern-title">RECOMONDED IN</h5>
            <ul>
              <li>Swelling</li>
          ...
          <!-- <img src="images/ayurveda/shiro-abhya.svg" alt="">
            ...
            <div class="divider"></div>
            <p>
              Shiro Abhyanga is characterised as a full-body massage and relaxation that targets the head, neck, and
              shoulder areas. The upper body is particularly vulnerable to stress.
            </p>
            <p>This reviving Ayurvedic massage uses oils loaded with herbs that are suited to the dosha being employed.
              Typically, the massage oil is pre-mixed with powerful, natural herbs that treat particular diseases.</p>
            <h5 class="box-icon-modern-title">RECOMONDED IN</h5>
            <ul>
              <li>Dandruff</li>
              <li>Hair fall</li>
        ...
        <div class="col-sm-6 col-lg-6 col-sm-12">
          ...
          <!-- <img src="images/ayurveda/pizhichil.svg" alt="">
            ...
            <div class="divider"></div>
            <p>A blend of two classical Ayurvedic treatments- Snehana which incorporates oleation and fomentation of the
              body with medicated oils and decotions using synchronised movements
            </p>
        ...
        <div class="col-sm-6 col-lg-6 col-sm-12">
          <article class="box-icon-modern modern-variant-2">
            ...
            <div class="divider"></div>
            <p>
              It begins with a full body massage before a specifically made medicinal paste is administered throughout
              the body for a set period of time. In addition to toning and tightening the skin tissue, it aids in
              removing heat and toxins from the body.
            </p>
            <p> <b> TYPES OF LEPAM :</b> </p>
            <ul>
              <li><b>Mukh lepam:</b> Ayurvedic facials with various herbal pastes to eliminate skin issues and beautify
                the skin</li>
        ...
        <div class="col-sm-6 col-lg-6 col-sm-12">
          ...
          <!-- <img src="images/ayurveda/vasti.svg" alt="">
            ...
            <div class="divider"></div>
            <p>
              By keeping warm medicinal oil in a particularly shaped frame in the sacrum or lumbar region, heat is
              applied there as part of the therapy.
            </p>
            <p>Localized areas receive fomentation as a result.</p>
            <p>Provides relief for sedentary lifestyle-related lower back pain The therapeutic benefits of the herbal
              oils utilised for this vasti include thorough cleansing and blood fortification, the development of strong
        ...
        <div class="col-sm-6 col-lg-6 col-sm-12 col-sm-12">
          ...
          <!-- <img src="images/ayurveda/janu.svg" alt="">
            ...
            <div class="divider"></div>
            <p>
              Knee issues are a result of an imbalance in the Vayu or wind in the region brought on by the Vata dosha
              imbalance. Swedana and warm medicinal oils aid Janu Vasti to combat the cold and dry conditions brought on
              by the imbalance.</p>
            <p>
              Janu Vasti is a specific Ayurvedic treatment that includes creating compartments around the knee joint or
              the site of inflammation or injury and filling them with therapeutic oil.
            </p>
            <h5 class="box-icon-modern-title">RECOMONDED IN</h5>
            <ul>
        ...
        <div class="col-sm-6 col-lg-6 col-sm-12">
          ...
          <!-- <img src="images/ayurveda/graev.svg" alt="">
            ...
            <div class="divider"></div>
            <p>
              It essentially involves holding of herbal oils on the spine, starting from the neck. It operates through
              Sweda (sweating) and falls under the Panchakarma strain of treatments. </p>
            <p>
      ...
      <div class="row no-gutters pricing-box-modern justify-content-lg-end">
        <div class="col-sm-6 col-lg-4">
          <div class="pricing-box-inner box-left">
            ...
            <a class="button-link button-link-icon" href="appointment.html">make an appointment
              <span class="icon fa-arrow-right icon-primary"></span></a>
          </div>
        </div>
        <div class="d-none d-lg-block col-lg-4 img-wrap">
          <img src="images/home-4-6-498x688.jpg" alt="" width="498" height="688" />
        </div>
        <div class="col-sm-6 col-lg-4">
