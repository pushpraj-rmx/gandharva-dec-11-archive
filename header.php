            ...
            <div class="rd-navbar-main-outer">
                <div class="rd-navbar-main">
                    ...
                    <div class="rd-navbar-panel">
                        ...
                        <!-- RD Navbar Brand-->
                        <div class="rd-navbar-brand align-items-center text-center"><a href="index.php"><img
                    ...
                    <div class="rd-navbar-main-element">
                        <div class="rd-navbar-nav-wrap">
                            <ul class="rd-navbar-nav">
                                ...
                                <li class="rd-nav-item"><a class="rd-nav-link" href="all-services.php">Services</a>
                                    <ul class="rd-menu rd-navbar-dropdown">
                                        <li class="rd-dropdown-item"> <a class="rd-dropdown-link "
                                                href="makeup.php">Makeup</a>
                                            <ul class="rd-menu rd-navbar-dropdown">
                                                <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                                        href="makeup.php">Permanent Makeup</a></li>
                                                <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                                        href="makeup.php">Semi Permanent Makeup</a></li>
                                            </ul>
                                        </li>
                                        <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                                href="alternative-tharapies.php">Alternative
                                                Tharapies</a></li>
                                        <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                                href="facials.php">Facials</a>
                                        </li>
                                        <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                                href="beauty-essentials.php">Beauty
                                                Essentials</a></li>
                                        <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                        ...
                                        <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                                ...
                                                Grooming</a></li>
                                        <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                                href="ayurveda-therapies.php">Ayurveda Therapies</a>
                                        </li>
                                        <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                ...
                                <li class="rd-nav-item "><a class="rd-nav-link"
                                        href="recomendation.php">Recommendation</a>
                                </li>
                                <li class="rd-nav-brand logos"><a href="index.php"><img src="images/gandharva_logo.png"
                                            alt="" /></a></li><br>
                                            <li class="rd-nav-item"><a class="rd-nav-link" href="all-services.php">Programs</a>
                                                <ul class="rd-menu rd-navbar-dropdown">
                                                    <!-- <li class="rd-dropdown-item"> <a class="rd-dropdown-link "
                                                            href="makeup.php">Makeup</a>
                                                        <ul class="rd-menu rd-navbar-dropdown">
                                                    ...
                                                    <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                                            href="ayurveda-therapies.php">Ayurveda
                                                            Therapies</a></li>
                                                    <!-- <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                                            href="facials.php">Facials</a>
                                                    </li>
                                ...
                                <li class="rd-nav-item"><a class="rd-nav-link" href="privacy-policy.php">Gallery</a>
                                </li>
                                <li class="rd-nav-item"><a class="rd-nav-link" href="terms-conditions.php"> Social
                                        Media</a></li>
                                <li class="rd-nav-item"><a class="rd-nav-link" href="contact_us.php">Contact
                                        Us</a></li>
                            </ul>
                            </li>
                            </ul>
