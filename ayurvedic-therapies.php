...
<head>
  <title>
    Best Ayurveda Therapies in Preet Vihar, Delhi | Effective Treatment
  </title>
  <meta
...
<body>
  ...
  <div class="page">
    ...
    <section class="section-page-title" style="
      ...
      <div class="container">
        <h1 class="page-title">Ayurveda therapy</h1>
      </div>
    </section>
        ...
        <div class="col-sm-6 col-lg-6 col-sm-12">
          <article class="box-icon-modern modern-variant-2">
            ...
            <h4 class="box-icon-modern-title">
              <a href="services.html">Udwarthanam</a>
            </h4>
            <div class="divider"></div>
            <p>
              The Udwarthanam massage is a therapeutic deep tissue massage that uses upward strokes to apply rubbing oil
              and herbal powder.
            </p>
            <p>
              The intensity of the massage produces heat, which causes the extra body fat to dissolve. Additionally, it
              can be quite effective in raising the body's immunity and lymphatic flow.
            </p>
